...
export const Intro: React.FC<Props> = (props) => {
  ...
  const name: string = props.content.global
    ? `: ${props.content.global.name}`
    : "";
  const data: any = {
    theme: {
  ...
  return (
    <div>
      <h1 className="flex items-center mb-5 text-2xl font-semibold">
        <svg
          className="mr-3"
          width="24"
          height="24"
        ...
        <span>{data[props.type].heading}</span>
      </h1>
